...
[0:a]atrim=start=3.3:duration=5.11,asetpts=PTS-STARTPTS[a0];
[v0]trim=start=0:duration=1,setpts=PTS-STARTPTS[v00];
[a0]atrim=start=0:duration=1,asetpts=PTS-STARTPTS[a00]" -map [v00] -map [a00] -preset ultrafast preview.mkv